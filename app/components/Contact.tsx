...
const LazyEarthCanvas = dynamic(() => import("./canvas/Earth"), {
  ssr: false,
  loading: () => <div className="text-white">Loading Earth...</div>,
});
...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Ajinkya Walunj",
          from_email: form.email,
          to_email: "ajinkya8975@gmail.com",
  ...
  useEffect(() => {
    const onIdle = () => setLoadEarth(true);
